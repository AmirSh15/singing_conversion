...
hps = utils.get_hparams_from_file("/home/so-vits-svc/configs/config.json")
dconfig = du.load_config("/home/so-vits-svc/configs/diffusion.yaml")
...
def preprocess():
    ...
    parser.add_argument(
        "--in_dir", type=str, default="/home/so-vits-svc/dataset/44k", help="path to input dir"
    )
    parser.add_argument(
