...
def clean_checkpoints(path_to_models='/home/so-vits-svc/logs/44k/', n_ckpts_to_keep=2, sort_by_time=True):
...
def get_hparams(init=True):
  ...
  parser.add_argument('-c', '--config', type=str, default="/home/so-vits-svc/configs/config.json",
                      help='JSON file for configuration')
  parser.add_argument('-m', '--model', type=str, required=True,
                      help='Model name')

  args = parser.parse_args()
  model_dir = os.path.join("/home/so-vits-svc/logs", args.model)
