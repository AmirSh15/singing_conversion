...
if __name__ == "__main__":
    ...
    config_template =  json.load(open("/home/so-vits-svc/configs_template/config_tiny_template.json")) if args.tiny else json.load(open("/home/so-vits-svc/configs_template/config_template.json"))
    train = []
    val = []
    idx = 0
    spk_dict = {}
    ...
    d_config_template = du.load_config("/home/so-vits-svc/configs_template/diffusion_template.yaml")
    ...
    with open("/home/so-vits-svc/configs/config.json", "w") as f:
